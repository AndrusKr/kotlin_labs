...
public class CreateNoteActivity extends BaseNoteActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        colorSpin = findViewById(R.id.color_spin);
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, colorStrings);
    ...
    private void saveNote() {
        ...
        int selectedColor = colorSpin.getSelectedItemPosition();
        ...
        if(TextUtils.isEmpty(title) && TextUtils.isEmpty(text))
        {
            ...
            String sTime = SDF.format(currentTime);
            ContentValues contentValues = new ContentValues();
            contentValues.put(NotesContract.Notes.COLUMN_TITLE, sTime);
            contentValues.put(NotesContract.Notes.COLUMN_NOTE, sTime);
            contentValues.put(NotesContract.Notes.COLUMN_COLOR, selectedColor);

            if (noteId == -1) {
                contentValues.put(NotesContract.Notes.COLUMN_CREATED_TS, sTime);
            }

            contentValues.put(NotesContract.Notes.COLUMN_UPDATED_TS, sTime);
